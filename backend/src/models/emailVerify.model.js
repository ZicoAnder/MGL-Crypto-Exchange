...
class EmailVerifyModel {
    ...
    findOne = async (params) => {
        try {
            ...
            // console.log("Result of Email Verification Query:", result);
    ...
    create = async ({ email, verify_code }) => {
        try {
            console.log("Attempting to insert:", email, verify_code);
            ...
            console.error("Error in create method (EmailVerifyModel):", error);
            return { error: error.sqlMessage };
        }
    }
